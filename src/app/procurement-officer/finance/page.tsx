...
// Mock data for procurement officer's payment requisitions
const mockPaymentRequisitions = [
  ...
  },
  {
    ...
    date: "2024-01-10",
    requestor: "Procurement Officer",
    purpose: "Service Contract Payment",
    amount: 1200000,
    status: "Approved",
  },
];

export default function ProcurementOfficerFinancePage() {
      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600">Create payment requisitions as a requestor</p>
          </div>
          <button
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">
                  UGX {(mockPaymentRequisitions.reduce((sum, r) => sum + r.amount, 0) / 1000000).toFixed(1)}M
                </p>
              </div>
            </div>
          </div>
