...
// Mock data for Hon. Secretary's inventory view
...
export default function HonSecretaryInventoryPage() {
                ...
                {mockInventoryItems.map((item) => (
                  <tr key={item.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      ...
                      <button className="text-green-600 hover:text-green-900">Download Report</button>
                    </td>
                  </tr>
                ))}
              </tbody>
