...
export default function HonSecretaryFinancePage() {
  ...
  return (
    <DashboardLayout userRole="hon-secretary">
      <div className="space-y-6">
        {/* Header */}
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Finance Approval</h1>
            <p className="text-gray-600">Review and approve payment requisitions and local purchase orders</p>
          </div>
        </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {mockPaymentRequisitions.filter(r => r.status === "Pending Secretary Approval").length + 
                   mockLocalPurchaseOrders.filter(l => l.status === "Pending Secretary Approval").length}
                </p>
              </div>
            </div>
          </div>
                  ...
                  {mockPaymentRequisitions.map((requisition) => (
                    <tr key={requisition.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        {requisition.status === "Pending Secretary Approval" && (
                          <button 
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {mockLocalPurchaseOrders.map((lpo) => (
                    <tr key={lpo.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        {lpo.status === "Pending Secretary Approval" && (
                          <button 
